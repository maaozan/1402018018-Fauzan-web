    ...
    <div class="banner header-text">
      <div class="owl-banner owl-carousel">
        ...
        <div class="banner-item-02">
          <div class="text-content">
            <h2>TAMBAH LAGI KOLEKSI GITARMU!</h2>
          </div>
        </div>
        <div class="banner-item-03">
          <div class="text-content">
            <h2>ASAH SKILL DENGAN GITAR BARU</h2>
          </div>
        </div>
      </div>
    </div>
        ...
        while ($row = $result->fetch_assoc()): ?>   
          <div class="col-md-4">
            <div class="product-item">
              <a href="deskripsi.php?id_gitar=<?php echo $row['id_gitar']; ?>"><img src="img/<?php echo $row['gambar_gitar']; ?>" alt=""></a>
              <div class="down-content">
                <a href="deskripsi.php?id_gitar=<?php echo $row['id_gitar']; ?>"><h4><?php echo $row['nama_gitar']; ?></h4></a>                
