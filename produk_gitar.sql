...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2022 at 02:15 PM
...
(25, 'Ibanez ARTCORE AS63', 4500000, 'Elektrik', 'Ibanez AS63-SFG merupakan semi hollowbody guitar yang menghasilkan tone yang sengau khas, dikombinasikan dengan Konfigurasi pickup Humbucker-humbucker membuat sound lebih warm dan luas, menggunakan Nyatoh wood pada neck membuat gitar ini lebih stabil. Tersedia dengan beberapa pilihan warna yang menarik.', 1, 'ibanez.png'),
(26, 'Epiphone Dot Hollowbody', 6000000, 'Elektrik', 'Mengambil konsep dari Gibson ES-335 yang melegenda, Epiphone menghadirkan Vibe dan sound yang serupa pada seri Dot Hollow. Dengan body semi hollow yang menawarkan fleksibitas tinggi untuk menghasilkan sound yang dirty namun tetap menghasilkan nuansa sound hollow.', 1, 'epiphone.png');
...
--
ALTER TABLE `produk_gitar`
  MODIFY `id_gitar` int(128) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
COMMIT;
