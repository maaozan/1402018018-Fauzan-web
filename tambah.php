        ...
        <div class="row">  
          ...
          <h2 style="color: black"></h2>
					<form action="tambahdata.php" method="post">
						...
						<input type="text" name="nama_gitar" class="form-control" placeholder="Nama Gitar" required>
						</div>
						<div class="form-group">
						<input type="text" name="jenis_gitar" class="form-control" placeholder="Jenis Gitar" required>
						</div>
						<div class="form-group">
						<input type="text" name="deskripsi_gitar" class="form-control" placeholder="Deskripsi Gitar" required>
						</div>
						<div class="form-group">
						<input type="text" name="stok_gitar" class="form-control" placeholder="Stok Gitar" required>
						</div>
                        <div class="form-group">
						<input type="text" name="gambar_gitar" class="form-control" placeholder="File Gambar Gitar" required>
						</div>
